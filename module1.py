...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.frame.setGeometry(QtCore.QRect(-10, -10, 1200, 1200))
...
"{background:#CAEBF2}")
        ...
        self.photo.setGeometry(QtCore.QRect(900, 120, 191, 181))
        self.photo.setAutoFillBackground(False)
        self.photo.setText("")
        self.photo.setPixmap(QtGui.QPixmap("weatherimage.jpg"))
        ...
        self.label_3.setPixmap(QtGui.QPixmap("../../weatherimage.jpg"))
